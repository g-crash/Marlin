 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "1.1.8.2"

  /**
   * Verbose version identifier which should contain a reference to the location
   * from where the binary was downloaded or the source code was compiled.
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " BugFix"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2018-04-28"
   ...
   */
  #define MACHINE_NAME "The Monster"
